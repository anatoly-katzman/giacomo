...
fragment AK_NS_PLAIN_FIRST_OPTION1:
            ...
            | '#' | '&' | '*' | '!' | '|' | '>' | '\'' | '"'
            | '%' | '@' | '`');
NS_PLAIN_FIRST_FLOW_OUT: AK_NS_PLAIN_FIRST_OPTION1
                        | ('?' | ':' | '-') NS_PLAIN_SAFE_FLOW_OUT;
NS_PLAIN_FIRST_FLOW_IN: AK_NS_PLAIN_FIRST_OPTION1
                        | ('?' | ':' | '-') NS_PLAIN_SAFE_FLOW_IN;
NS_PLAIN_FIRST_BLOCK_KEY: AK_NS_PLAIN_FIRST_OPTION1
                        | ('?' | ':' | '-') NS_PLAIN_SAFE_BLOCK_KEY;
NS_PLAIN_FIRST_FLOW_KEY: AK_NS_PLAIN_FIRST_OPTION1
                        | ('?' | ':' | '-') NS_PLAIN_SAFE_FLOW_KEY;

// [127]	ns-plain-safe(c)	::=	c = flow-out  ⇒ ns-plain-safe-out
//                                  c = flow-in   ⇒ ns-plain-safe-in
//                                  c = block-key ⇒ ns-plain-safe-out
//                                  c = flow-key  ⇒ ns-plain-safe-in
NS_PLAIN_SAFE_FLOW_OUT: NS_PLAIN_SAFE_OUT;
NS_PLAIN_SAFE_FLOW_IN: NS_PLAIN_SAFE_IN;
NS_PLAIN_SAFE_BLOCK_KEY: NS_PLAIN_SAFE_OUT;
NS_PLAIN_SAFE_FLOW_KEY: NS_PLAIN_SAFE_IN;
...
//                              | ( “:” /* Followed by an ns-plain-safe(c) */ )
NS_PLAIN_CHAR_FLOW_OUT: ~('\u0020' | '\u0009' | ':' | '#')
                        | (NS_CHAR '#')
                        | (':' NS_PLAIN_SAFE_FLOW_OUT);
NS_PLAIN_CHAR_FLOW_IN: ~('\u0020' | '\u0009' | ',' | '[' | ']' | '{' | '}'  | ':' | '#')
                        | (NS_CHAR '#')
                        | (':' NS_PLAIN_SAFE_FLOW_IN);
NS_PLAIN_CHAR_BLOCK_KEY: ~('\u0020' | '\u0009' | ':' | '#')
                        | (NS_CHAR '#')
                        | (':' NS_PLAIN_SAFE_BLOCK_KEY);
NS_PLAIN_CHAR_FLOW_KEY: ~('\u0020' | '\u0009' | ',' | '[' | ']' | '{' | '}' | ':' | '#')
                        | (NS_CHAR '#')
                        | (':' NS_PLAIN_SAFE_FLOW_KEY);
...
NS_PLAIN_01_FLOW_OUT: NS_PLAIN_MULTI_LINE_01_FLOW_OUT;
NS_PLAIN_02_FLOW_OUT: NS_PLAIN_MULTI_LINE_02_FLOW_OUT;
NS_PLAIN_03_FLOW_OUT: NS_PLAIN_MULTI_LINE_03_FLOW_OUT;
NS_PLAIN_04_FLOW_OUT: NS_PLAIN_MULTI_LINE_04_FLOW_OUT;
NS_PLAIN_05_FLOW_OUT: NS_PLAIN_MULTI_LINE_05_FLOW_OUT;

NS_PLAIN_01_FLOW_IN: NS_PLAIN_MULTI_LINE_01_FLOW_IN;
NS_PLAIN_02_FLOW_IN: NS_PLAIN_MULTI_LINE_02_FLOW_IN;
NS_PLAIN_03_FLOW_IN: NS_PLAIN_MULTI_LINE_03_FLOW_IN;
NS_PLAIN_04_FLOW_IN: NS_PLAIN_MULTI_LINE_04_FLOW_IN;
NS_PLAIN_05_FLOW_IN: NS_PLAIN_MULTI_LINE_05_FLOW_IN;

NS_PLAIN_BLOCK_KEY: NS_PLAIN_ONE_LINE_BLOCK_KEY;
NS_PLAIN_FLOW_KEY: NS_PLAIN_ONE_LINE_FLOW_KEY;


// [132]	nb-ns-plain-in-line(c)	::=	( s-white* ns-plain-char(c) )*
fragment NB_NS_PLAIN_IN_LINE_FLOW_OUT: (S_WHITE* NS_PLAIN_CHAR_FLOW_OUT)*;
fragment NB_NS_PLAIN_IN_LINE_FLOW_IN: (S_WHITE* NS_PLAIN_CHAR_FLOW_IN)*;
fragment NB_NS_PLAIN_IN_LINE_BLOCK_KEY: (S_WHITE* NS_PLAIN_CHAR_BLOCK_KEY)*;
fragment NB_NS_PLAIN_IN_LINE_FLOW_KEY: (S_WHITE* NS_PLAIN_CHAR_FLOW_KEY)*;
...
NS_PLAIN_ONE_LINE_FLOW_IN: NS_PLAIN_FIRST_FLOW_IN NB_NS_PLAIN_IN_LINE_FLOW_IN;
NS_PLAIN_ONE_LINE_BLOCK_KEY: NS_PLAIN_FIRST_BLOCK_KEY NB_NS_PLAIN_IN_LINE_BLOCK_KEY;
NS_PLAIN_ONE_LINE_FLOW_KEY: NS_PLAIN_FIRST_FLOW_KEY NB_NS_PLAIN_IN_LINE_FLOW_KEY;

// [134]	s-ns-plain-next-line(n,c)	::=	s-flow-folded(n)
//                                          ns-plain-char(c) nb-ns-plain-in-line(c)
S_NS_PLAIN_NEXT_LINE_01_FLOW_OUT: S_FLOW_FOLDED_01 NS_PLAIN_CHAR_FLOW_OUT NB_NS_PLAIN_IN_LINE_FLOW_OUT;
S_NS_PLAIN_NEXT_LINE_02_FLOW_OUT: S_FLOW_FOLDED_02 NS_PLAIN_CHAR_FLOW_OUT NB_NS_PLAIN_IN_LINE_FLOW_OUT;
S_NS_PLAIN_NEXT_LINE_03_FLOW_OUT: S_FLOW_FOLDED_03 NS_PLAIN_CHAR_FLOW_OUT NB_NS_PLAIN_IN_LINE_FLOW_OUT;
S_NS_PLAIN_NEXT_LINE_04_FLOW_OUT: S_FLOW_FOLDED_04 NS_PLAIN_CHAR_FLOW_OUT NB_NS_PLAIN_IN_LINE_FLOW_OUT;
S_NS_PLAIN_NEXT_LINE_05_FLOW_OUT: S_FLOW_FOLDED_05 NS_PLAIN_CHAR_FLOW_OUT NB_NS_PLAIN_IN_LINE_FLOW_OUT;

S_NS_PLAIN_NEXT_LINE_01_FLOW_IN: S_FLOW_FOLDED_01 NS_PLAIN_CHAR_FLOW_IN NB_NS_PLAIN_IN_LINE_FLOW_IN;
S_NS_PLAIN_NEXT_LINE_02_FLOW_IN: S_FLOW_FOLDED_02 NS_PLAIN_CHAR_FLOW_IN NB_NS_PLAIN_IN_LINE_FLOW_IN;
S_NS_PLAIN_NEXT_LINE_03_FLOW_IN: S_FLOW_FOLDED_03 NS_PLAIN_CHAR_FLOW_IN NB_NS_PLAIN_IN_LINE_FLOW_IN;
S_NS_PLAIN_NEXT_LINE_04_FLOW_IN: S_FLOW_FOLDED_04 NS_PLAIN_CHAR_FLOW_IN NB_NS_PLAIN_IN_LINE_FLOW_IN;
S_NS_PLAIN_NEXT_LINE_05_FLOW_IN: S_FLOW_FOLDED_05 NS_PLAIN_CHAR_FLOW_IN NB_NS_PLAIN_IN_LINE_FLOW_IN;

S_NS_PLAIN_NEXT_LINE_01_BLOCK_KEY: S_FLOW_FOLDED_01 NS_PLAIN_CHAR_BLOCK_KEY NB_NS_PLAIN_IN_LINE_BLOCK_KEY;
S_NS_PLAIN_NEXT_LINE_02_BLOCK_KEY: S_FLOW_FOLDED_02 NS_PLAIN_CHAR_BLOCK_KEY NB_NS_PLAIN_IN_LINE_BLOCK_KEY;
S_NS_PLAIN_NEXT_LINE_03_BLOCK_KEY: S_FLOW_FOLDED_03 NS_PLAIN_CHAR_BLOCK_KEY NB_NS_PLAIN_IN_LINE_BLOCK_KEY;
S_NS_PLAIN_NEXT_LINE_04_BLOCK_KEY: S_FLOW_FOLDED_04 NS_PLAIN_CHAR_BLOCK_KEY NB_NS_PLAIN_IN_LINE_BLOCK_KEY;
S_NS_PLAIN_NEXT_LINE_05_BLOCK_KEY: S_FLOW_FOLDED_05 NS_PLAIN_CHAR_BLOCK_KEY NB_NS_PLAIN_IN_LINE_BLOCK_KEY;

S_NS_PLAIN_NEXT_LINE_01_FLOW_KEY: S_FLOW_FOLDED_01 NS_PLAIN_CHAR_FLOW_KEY NB_NS_PLAIN_IN_LINE_FLOW_KEY;
S_NS_PLAIN_NEXT_LINE_02_FLOW_KEY: S_FLOW_FOLDED_02 NS_PLAIN_CHAR_FLOW_KEY NB_NS_PLAIN_IN_LINE_FLOW_KEY;
S_NS_PLAIN_NEXT_LINE_03_FLOW_KEY: S_FLOW_FOLDED_03 NS_PLAIN_CHAR_FLOW_KEY NB_NS_PLAIN_IN_LINE_FLOW_KEY;
S_NS_PLAIN_NEXT_LINE_04_FLOW_KEY: S_FLOW_FOLDED_04 NS_PLAIN_CHAR_FLOW_KEY NB_NS_PLAIN_IN_LINE_FLOW_KEY;
S_NS_PLAIN_NEXT_LINE_05_FLOW_KEY: S_FLOW_FOLDED_05 NS_PLAIN_CHAR_FLOW_KEY NB_NS_PLAIN_IN_LINE_FLOW_KEY;

// [135]	ns-plain-multi-line(n,c)	::=	ns-plain-one-line(c)
//                                          s-ns-plain-next-line(n,c)*
NS_PLAIN_MULTI_LINE_01_FLOW_OUT: NS_PLAIN_ONE_LINE_FLOW_OUT S_NS_PLAIN_NEXT_LINE_01_FLOW_OUT*;
NS_PLAIN_MULTI_LINE_02_FLOW_OUT: NS_PLAIN_ONE_LINE_FLOW_OUT S_NS_PLAIN_NEXT_LINE_02_FLOW_OUT*;
NS_PLAIN_MULTI_LINE_03_FLOW_OUT: NS_PLAIN_ONE_LINE_FLOW_OUT S_NS_PLAIN_NEXT_LINE_03_FLOW_OUT*;
NS_PLAIN_MULTI_LINE_04_FLOW_OUT: NS_PLAIN_ONE_LINE_FLOW_OUT S_NS_PLAIN_NEXT_LINE_04_FLOW_OUT*;
NS_PLAIN_MULTI_LINE_05_FLOW_OUT: NS_PLAIN_ONE_LINE_FLOW_OUT S_NS_PLAIN_NEXT_LINE_05_FLOW_OUT*;

NS_PLAIN_MULTI_LINE_01_FLOW_IN: NS_PLAIN_ONE_LINE_FLOW_IN S_NS_PLAIN_NEXT_LINE_01_FLOW_IN*;
NS_PLAIN_MULTI_LINE_02_FLOW_IN: NS_PLAIN_ONE_LINE_FLOW_IN S_NS_PLAIN_NEXT_LINE_02_FLOW_IN*;
NS_PLAIN_MULTI_LINE_03_FLOW_IN: NS_PLAIN_ONE_LINE_FLOW_IN S_NS_PLAIN_NEXT_LINE_03_FLOW_IN*;
NS_PLAIN_MULTI_LINE_04_FLOW_IN: NS_PLAIN_ONE_LINE_FLOW_IN S_NS_PLAIN_NEXT_LINE_04_FLOW_IN*;
NS_PLAIN_MULTI_LINE_05_FLOW_IN: NS_PLAIN_ONE_LINE_FLOW_IN S_NS_PLAIN_NEXT_LINE_05_FLOW_IN*;

NS_PLAIN_MULTI_LINE_01_BLOCK_KEY: NS_PLAIN_ONE_LINE_BLOCK_KEY S_NS_PLAIN_NEXT_LINE_01_BLOCK_KEY*;
NS_PLAIN_MULTI_LINE_02_BLOCK_KEY: NS_PLAIN_ONE_LINE_BLOCK_KEY S_NS_PLAIN_NEXT_LINE_02_BLOCK_KEY*;
NS_PLAIN_MULTI_LINE_03_BLOCK_KEY: NS_PLAIN_ONE_LINE_BLOCK_KEY S_NS_PLAIN_NEXT_LINE_03_BLOCK_KEY*;
NS_PLAIN_MULTI_LINE_04_BLOCK_KEY: NS_PLAIN_ONE_LINE_BLOCK_KEY S_NS_PLAIN_NEXT_LINE_04_BLOCK_KEY*;
NS_PLAIN_MULTI_LINE_05_BLOCK_KEY: NS_PLAIN_ONE_LINE_BLOCK_KEY S_NS_PLAIN_NEXT_LINE_05_BLOCK_KEY*;

NS_PLAIN_MULTI_LINE_01_FLOW_KEY: NS_PLAIN_ONE_LINE_FLOW_KEY S_NS_PLAIN_NEXT_LINE_01_FLOW_KEY*;
NS_PLAIN_MULTI_LINE_02_FLOW_KEY: NS_PLAIN_ONE_LINE_FLOW_KEY S_NS_PLAIN_NEXT_LINE_02_FLOW_KEY*;
NS_PLAIN_MULTI_LINE_03_FLOW_KEY: NS_PLAIN_ONE_LINE_FLOW_KEY S_NS_PLAIN_NEXT_LINE_03_FLOW_KEY*;
NS_PLAIN_MULTI_LINE_04_FLOW_KEY: NS_PLAIN_ONE_LINE_FLOW_KEY S_NS_PLAIN_NEXT_LINE_04_FLOW_KEY*;
NS_PLAIN_MULTI_LINE_05_FLOW_KEY: NS_PLAIN_ONE_LINE_FLOW_KEY S_NS_PLAIN_NEXT_LINE_05_FLOW_KEY*;
